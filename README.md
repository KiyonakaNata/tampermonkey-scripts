...
| ファイル | 概要 |
|---|---|
| [claude_tools.user.js](claude_tools.user.js) | 複数機能を1スクリプトに統合。Tampermonkeyメニューから個別ON/OFF。下記4機能を内包: |
...
| ファイル | 概要 |
|---|---|
| [etyping_tools.user.js](etyping_tools.user.js) | 複数機能を1スクリプトに統合。Tampermonkeyメニューから個別ON/OFF。下記4機能を内包: |
...
![etyping_tools preview](img/etyping_tools_preview.jpg)
...
- [claude_tools.user.js](https://raw.githubusercontent.com/KiyonakaNata/tampermonkey-scripts/main/claude_tools.user.js)
...
- [etyping_tools.user.js](https://raw.githubusercontent.com/KiyonakaNata/tampermonkey-scripts/main/etyping_tools.user.js)
